...
<table style="width: 90%">
		<tr>
			<th>주문번호</th><th>상품명</th><th>주문량</th><th>주문일자</th><th>주문상태</th>
		</tr>
<%
	...
	ArrayList<OrderBean> list = orderMgr.getOrder(id); 
	 ...
	 if(list.size() == 0) {
%>
		<tr><td colspan="5" style="text-align: center;">주문상품이 없습니다.</td></tr>
<% 
	} else {
...
<%
	switch(ord.getState()) {
		case "1" : out.println("접수완료"); break;
		case "2" : out.println("입금확인"); break;
		case "3" : out.println("배송준비"); break;
		case "4" : out.println("배송 중"); break;
